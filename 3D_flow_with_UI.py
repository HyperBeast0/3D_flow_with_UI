...
from func_solution.solution_for_Oy_inv import circle_calculate_slice_Oy_inv_explicit, \
    rectangle_calculate_slice_Oy_inv_explicit, \
...
from func_solution.solution_for_Oz_inv import circle_calculate_slice_Oz_inv_explicit, \
    rectangle_calculate_slice_Oz_inv_explicit, \
...
def get_circle_Oy_radius():
    ...
    if radius is not None and explicit.get() == 1 and implicit.get() == 0:
        try:
            circle_calculate_slice_Oy_explicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                               radius)
        except:
            open_warning_about_forms()
...
def get_circle_Oy_inv_radius():
    ...
    if radius is not None and explicit.get() == 1 and implicit.get() == 0:
        try:
            circle_calculate_slice_Oy_inv_explicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                                   radius)
        except:
            open_warning_about_forms()
    elif radius is not None and explicit.get() == 0 and implicit.get() == 1:
        try:
            circle_calculate_slice_Oy_inv_implicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                                   radius)
        except:
            open_warning_about_forms()
    else:
...
def get_circle_Oz_radius():
    ...
    if radius is not None and explicit.get() == 1 and implicit.get() == 0:
        try:
            circle_calculate_slice_Oz_explicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                               radius)
        except:
            open_warning_about_forms()
    elif radius is not None and explicit.get() == 0 and implicit.get() == 1:
        try:
            circle_calculate_slice_Oz_implicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                               radius)
        except:
            open_warning_about_forms()
    else:
...
def get_circle_Oz_inv_radius():
    ...
    if radius is not None and explicit.get() == 1 and implicit.get() == 0:
        try:
            circle_calculate_slice_Oz_inv_explicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                                   radius)
        except:
            open_warning_about_forms()
    elif radius is not None and explicit.get() == 0 and implicit.get() == 1:
        try:
            circle_calculate_slice_Oz_inv_implicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                                   radius)
        except:
            open_warning_about_forms()
    else:
...
def get_rectangle_Oy_dimensions():
    ...
    if length is not None and height is not None and explicit.get() == 1 and implicit.get() == 0:
        try:
            rectangle_calculate_slice_Oy_explicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                                  length,
                                                  height)
        except:
            open_warning_about_forms()
        ...
        try:
            rectangle_calculate_slice_Oy_implicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                                  length,
                                                  height)
        except:
            open_warning_about_forms()
...
def get_rectangle_Oy_inv_dimensions():
    ...
    if length is not None and height is not None and explicit.get() == 1 and implicit.get() == 0:
        try:
            rectangle_calculate_slice_Oy_inv_explicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(),
                                                      coord_y_in.get(),
                                                      length, height)
        except:
            open_warning_about_forms()
        ...
        try:
            rectangle_calculate_slice_Oy_inv_implicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(),
                                                      coord_y_in.get(), length,
                                                      height)
        except:
            open_warning_about_forms()
    else:
...
def get_rectangle_Oz_dimensions():
    ...
    if length is not None and width is not None and explicit.get() == 1 and implicit.get() == 0:
        try:
            rectangle_calculate_slice_Oz_explicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                                  length,
                                                  width)
        except:
            open_warning_about_forms()
        ...
        try:
            rectangle_calculate_slice_Oz_implicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(), coord_y_in.get(),
                                                  length,
                                                  width)
        except:
            open_warning_about_forms()
...
def get_rectangle_Oz_inv_dimensions():
    ...
    if length is not None and width is not None and explicit.get() == 1 and implicit.get() == 0:
        try:
            rectangle_calculate_slice_Oz_inv_explicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(),
                                                      coord_y_in.get(),
                                                      length, width)
        except:
            open_warning_about_forms()
        ...
        try:
            rectangle_calculate_slice_Oz_inv_implicit(grid_x_in.get(), grid_y_in.get(), coord_x_in.get(),
                                                      coord_y_in.get(), length,
                                                      width)
        except:
            open_warning_about_forms()
