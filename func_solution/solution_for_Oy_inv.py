...
def circle_calculate_slice_Oy_inv_explicit(grid_x, grid_y, coord_x, coord_y, radius):
    # Константы
...
def circle_calculate_slice_Oy_inv_implicit(grid_x, grid_y, coord_x, coord_y, radius):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
...
def rectangle_calculate_slice_Oy_inv_explicit(grid_x, grid_y, coord_x, coord_y, length, height):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
...
def rectangle_calculate_slice_Oy_inv_implicit(grid_x, grid_y, coord_x, coord_y, length, height):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
...
def circle_streamlines_Oy_inv(grid_x, grid_y, coord_x, coord_y, radius):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
...
def rectangle_streamlines_Oy_inv(grid_x, grid_y, coord_x, coord_y, length, width):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
