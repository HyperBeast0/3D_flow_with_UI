...
def circle_calculate_slice_Oz_inv_explicit(grid_x, grid_y, coord_x, coord_y, radius):
    # Константы
    ...
    def solve_flow(u, v, p, dt, nt):
        for i in range(nt):
            ...
            for i in range(0, nx):
                u[i, 0] = u[i, -1] = 1 # Граниченое условие слева и справа
...
def circle_calculate_slice_Oz_inv_implicit(grid_x, grid_y, coord_x, coord_y, radius):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
...
def rectangle_calculate_slice_Oz_inv_explicit(grid_x, grid_y, coord_x, coord_y, length, width):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
...
def rectangle_calculate_slice_Oz_inv_implicit(grid_x, grid_y, coord_x, coord_y, length, width):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
...
def circle_streamlines_Oz_inv(grid_x, grid_y, coord_x, coord_y, radius):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
...
def rectangle_streamlines_Oz_inv(grid_x, grid_y, coord_x, coord_y, length, width):
    # Константы
    U, V = 1.0, 1.0  # Скорости потока
    kv = 0.1  # Кинематическая вязкость
    rho = 1.0  # Плотность
